...
<head>
    ...
    <title>Bob & sil Global | Waste management</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/compound.jpg" alt="bob and sil">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="existence">
            ...
            <hr>
            <div class="story">
                <p id="first_story">At Bob & Sil, we adhere to national and global standards in the oil and gas industry in providing petroleum waste management. We provide bespoke waste management solutions in the petroleum industry.
                    <br><br>
                    We provide state-of-the-art and traditional treatment and control methods for removing, controlling, and treating waste problems.
                    <br>
                    We have identified the activities that potentially cause environmental pollution and common wastes associated with Oil and gas exploration and production (E and P) activities.
                    <br>
                    This enables us to provide excellent solutions in wastes management practices, selection of treatment and disposal methods, oil-recovery and/or removal methods, water-removal methods or dewatering, disposal methods, and other concerns about spent catalysts in the petroleum industry and their management, and handling of heavy metals.
                    <br><br>
                    The choice of treatment and disposal methods that we adopt depends largely on the physical and chemical properties of the waste or the waste characteristics, regulatory requirements, and the availability of facilities to process these wastes.<br>
                    <a id="invest_link" href="views/login_page.php" title="contact us">Get a quote <i class="fas fa-receipt"></i></a>
                    <img src="images/vessel4.jpg" alt="Admin building">
                </p>
                <div class="more_notes">
                    <img src="images/tank_farm2.jpg" alt="bob and sil about">
