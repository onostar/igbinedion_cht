...
<head>
    ...
    <title>Bob & sil Global | Petroleum</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/bob_sil_tank_farm.jpg" alt="bob and sil">
                    </div>
                    <div class="taglines">
                        <h2>Petroleum storage & Haulage</h2>
    ...
    <main>
        <section id="existence">
            <h2>Petroleum Distribution</h2>
            <hr>
            <h3>Petroleum Storage/Haulage</h3>
            <div class="story">
                <p id="first_story">At <strong>Bob & Sil</strong>, we are active in the purchase, shipping and marketing of refined petroleum products such as Automotive Gas Oil (AGO), with the addition of the Dual Purpose Kerosene (DPK) and Premium Motor Spirit (PMS), in a while<br>We imports petroleum products from international traders, using our own storage facilities for the retailing and marketing of the petroleum products.<br><br>Our Company’s storage facilities, which is being upgraded to a mono depot is located at Delta State Nigeria, with a total storage capacity of 380,000 litres, and it is in the process of being increased to a mono depot of over 10million litres.<br>We currently operate multiple retail outlets. Expansion is well to increase the number of retail outlets in its tens over the next 3 years.<br>
