...
<head>
    ...
    <title>Bob & sil Global | Petroleum Sales</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/vessel3.jpg" alt="bob and sil">
                    </div>
                    <div class="taglines">
                        <h2>Offshore Supplies</h2>
    ...
    <main>
        <section id="existence">
            <h2>Offshore sales and Supplies</h2>
            <hr>
            <div class="story">
                <p id="first_story">At Bob & Sil, we provide a wide selection of off-shore support services that ensures our clients operations are fully optimized and they receive value for their money.<br>>Our experience in the Nigerian maritime industry in combination with our vast network allows us to provide offshore supply within the shortest delivery time among other maritime suppliers in the region. This also enables us to quote high quality products at a low price.<br><br>>Our team provides invaluable support at all levels to help customers reduce costs and risk by making informed choices at the earliest possible stage.<br>>We are committed to ensuring, implementing, maintaining, review and continually improving national and global regulatory standards with consideration to customer satisfaction and interested parties.<br><br>>Our quick response to the customer’s needs in the past has shown and is still showing them that we are a trusted partner to them, who knows how important speed, quality, effectiveness are in the off-shore supply market.<br>
